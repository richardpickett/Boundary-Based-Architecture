...
| Artifact | Role |
|----------|------|
| [`CHARTER.md`](CHARTER.md) | Living charter (rules, agent loop, confirmation checklist) |
...
```text
.
├─ CHARTER.md          # authoritative practice charter
├─ theory/             # essays, rationale, history
├─ agents/             # prompts, roles, harness wiring for BBP
...
Working charter from a design conversation. Not yet a ratified organizational standard. Adoption “done” criteria are in charter §14.
